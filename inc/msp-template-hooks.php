...
add_action(
  ...
  "cheque_payment_method_order_status_to_processing",
  20,
  1
);
 ...
 */
add_action(
  "wp_ajax_msp_set_estimated_delivery_date",
  "msp_set_estimated_delivery_date"
);
add_action(
  "wp_ajax_nopriv_msp_set_estimated_delivery_date",
  "msp_set_estimated_delivery_date"
);

add_action(
  "wp_ajax_msp_get_product_size_guide_src",
  "msp_get_product_size_guide_src"
);
add_action(
  "wp_ajax_nopriv_msp_get_product_size_guide_src",
  "msp_get_product_size_guide_src"
);

add_action("wp_ajax_msp_delete_specification", "msp_delete_specification");
add_action(
  "wp_ajax_nopriv_msp_delete_specification",
  "msp_delete_specification"
);
...
add_action(
  "wp_ajax_msp_get_promo_pop_up_link_and_image",
  "msp_get_promo_pop_up_link_and_image"
);
add_action(
  "wp_ajax_nopriv_msp_get_promo_pop_up_link_and_image",
  "msp_get_promo_pop_up_link_and_image"
);

add_action(
  "wp_ajax_msp_get_leave_feedback_form",
  "msp_get_leave_feedback_form"
);
add_action(
  "wp_ajax_nopriv_msp_get_leave_feedback_form",
  "msp_get_leave_feedback_form"
);

add_action("wp_ajax_msp_process_feedback_form", "msp_process_feedback_form");
add_action(
  "wp_ajax_nopriv_msp_process_feedback_form",
  "msp_process_feedback_form"
);

add_action(
  "wp_ajax_msp_process_customer_submit_question",
  "msp_process_customer_submit_question"
);
add_action(
  "wp_ajax_nopriv_msp_process_customer_submit_question",
  "msp_process_customer_submit_question"
);

add_action(
  "wp_ajax_msp_process_customer_submit_awnser",
  "msp_process_customer_submit_awnser"
);
add_action(
  "wp_ajax_nopriv_msp_process_customer_submit_awnser",
  "msp_process_customer_submit_awnser"
);
...
add_action(
  "wp_ajax_msp_get_variation_price_html",
  "msp_get_variation_price_html"
);
add_action(
  "wp_ajax_nopriv_msp_get_variation_price_html",
  "msp_get_variation_price_html"
);
...
add_action(
  "admin_post_nopriv_msp_process_create_review",
  "msp_process_create_review"
);

//contact_form - /contact
add_action("wp_ajax_msp_process_contact_form", "msp_process_contact_form");
add_action(
  "wp_ajax_nopriv_msp_process_contact_form",
  "msp_process_contact_form"
);
...
add_action(
  "woocommerce_single_product_summary",
  "msp_free_shipping_message",
  37
);
add_action(
  "woocommerce_single_product_summary",
  "msp_close_order_tab_content_tag",
  50
);
...
add_action(
  "woocommerce_product_additional_information",
  "msp_get_additional_information",
  5,
  1
);
add_action(
  "woocommerce_product_additional_information",
  "msp_product_specification_html",
  10,
  1
);
...
add_action(
  ...
  "msp_mobile_product_filter_button",
  5
);
...
add_action(
  "woocommerce_shop_loop_item_title",
  "msp_template_loop_product_link_open",
  5
);
...
add_filter(
  "msp_additional_information_html",
  "msp_get_product_metadata",
  10,
  1
);
add_filter(
  "msp_additional_information_html",
  "msp_product_additional_information_html",
  15,
  1
);
