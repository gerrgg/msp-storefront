		...
		<main id="main" class="site-main" role="main">
			...
			<div class="error-404 not-found">
				...
				<div class="page-content">
					...
					if ( storefront_is_woocommerce_activated() ) {
						echo '<div class="row">';
							echo '<section class="col-12 col-sm-6" aria-label="' . esc_html__( 'Promoted Products', 'storefront' ) . '">';
								storefront_promoted_products();
							echo '</section>';
							echo '<nav class="col-12 col-sm-6" aria-label="' . esc_html__( 'Product Categories', 'storefront' ) . '">';
